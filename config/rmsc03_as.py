...
parser = argparse.ArgumentParser(
    description="Detailed options for RMSC03 + Avellaneda-Stoikov config."
)
...
parser.add_argument(
    "--use-obi", action="store_true", help="Ativa a Camada 1 (Preditor OBI)"
)
parser.add_argument(
    "--use-hedge", action="store_true", help="Ativa a Camada 2 (Hedge SPY)"
)
parser.add_argument(
...
agent_count += 1
agent_types.append("AvellanedaStoikovAgent")
