...
log_orders = False  # CORRIGIDO: Previne explosão de log dos Noise Agents
book_freq = "0"  # CORRIGIDO: String para o parser temporal da Bolsa
...
r_bar = int(1e5)  # CORRIGIDO: Cast explícito para int
sigma_n = int(r_bar / 10)  # CORRIGIDO: Cast explícito para int
kappa = 1.67e-15
lambda_a = 7e-11
...
# CORRIGIDO: append em vez de extend
